                            ...
                            //si kilat sameday
                                ...
                                if (input == 0){
                                    ...
                                    if (saldo >= totalAkhir){
                                        ...
                                        printf("barang anda akan sampai sekitar 1 hari dari sekarang \n");
                                        printf("\n+------------+------------+\n");
                            ...
                            //si kilat regular
                                ...
                                if (input == 0){
                                    ...
                                    if (saldo >= totalAkhir){
                                        ...
                                        fclose(file);
                                        printf("anda telah berhasil checkout barang anda\n");
                                        printf("barang anda akan sampai sekitar 4 hari dari sekarang \n");
                                        printf("\n+------------+------------+\n");
                                        printf("| sisa saldo | %-11d|\n",saldo-totalAkhir);
                                        printf("+------------+------------+\n\n");
                                        printf("untuk lebih detail silahkan cek pada menu status belanja\n");
                            ...
                            //si kilat ekonomis
                                ...
                                if (input == 0){
                                    ...
                                    if (saldo >= totalAkhir){
                                        ...
                                        fclose(file);
                                        printf("anda telah berhasil checkout barang anda\n");
                                        printf("barang anda akan sampai sekitar 7 hari dari sekarang \n");
                                        printf("\n+------------+------------+\n");
                                        printf("| sisa saldo | %-11d|\n",saldo-totalAkhir);
                                        printf("+------------+------------+\n\n");
                                        printf("untuk lebih detail silahkan cek pada menu status belanja\n");
                            ...
                            //dinamo kebut sehari
                                ...
                                if (input == 0){
                                    ...
                                    if (saldo >= totalAkhir){
                                        ...
                                        fclose(file);
                                        printf("anda telah berhasil checkout barang anda\n");
                                        printf("barang anda akan sampai 6-18 jam kedepan\n");
                                        printf("\n+------------+------------+\n");
                                        printf("| sisa saldo | %-11d|\n",saldo-totalAkhir);
                                        printf("+------------+------------+\n\n");
                                        printf("untuk lebih detail silahkan cek pada menu status belanja\n");
                            ...
                            //dinamo regular
                                ...
                                if (input == 0){
                                    ...
                                    if (saldo >= totalAkhir){
                                        ...
                                        fclose(file);
                                        printf("anda telah berhasil checkout barang anda\n");
                                        printf("barang anda akan sampai 3 hari kedepan\n");
                                        printf("\n+------------+------------+\n");
                                        printf("| sisa saldo | %-11d|\n",saldo-totalAkhir);
                                        printf("+------------+------------+\n\n");
                                        printf("untuk lebih detail silahkan cek pada menu status belanja\n");
                            ...
                            //dinamo ekonomis
                                ...
                                if (input == 0){
                                    ...
                                    if (saldo >= totalAkhir){
                                        ...
                                        fclose(file);
                                        printf("anda telah berhasil checkout barang anda\n");
                                        printf("barang anda akan sampai 4-6 hari kedepan\n");
                                        printf("\n+------------+------------+\n");
                                        printf("| sisa saldo | %-11d|\n",saldo-totalAkhir);
                                        printf("+------------+------------+\n\n");
                                        printf("untuk lebih detail silahkan cek pada menu status belanja\n");
                ...
                if (input == 0){
                    ...
                    if(totalHarga == 0){
                        ...
                        if(input == 0){
                            ...
                            //untuk nyamain array keranjang sama array obat, terus nambahin stok, sama ngurangin terjual
                            for(int i = 0;i<jumlahstatusbelanja;i++){
                                for(int j = 0;j<jumlahObat;j++){
                                    
                                    if (strcmp(statusbelanja[i][0],obat[j][0]) == 0 ){
                                        int Terjual = atoi(obat[j][4]);
                                        Terjual -= 1;
                                        sprintf(obat[j][4], "%d", Terjual);
                            ...
                            //untuk nyamain array keranjang sama array buku, terus nambahin stok, sama ngurangin terjual
                            for(int i = 0;i<jumlahstatusbelanja;i++){
                                for(int j = 0;j<jumlahBuku;j++){
                                    
                                    if (strcmp(statusbelanja[i][0],buku[j][0]) == 0 ){
                                        int Terjual = atoi(buku[j][4]);
                                        Terjual -= 1;
                                        sprintf(buku[j][4], "%d", Terjual);
                            ...
                            //untuk nyamain array keranjang sama array fashion, terus nambahin stok, sama ngurangin terjual
                            for(int i = 0;i<jumlahstatusbelanja;i++){
                                for(int j = 0;j<jumlahFashion;j++){
                                    
                                    if (strcmp(statusbelanja[i][0],fashion[j][0]) == 0 ){
                                        int Terjual = atoi(fashion[j][4]);
                                        Terjual -= 1;
                                        sprintf(fashion[j][4], "%d", Terjual);
                            ...
                            //untuk nyamain array keranjang sama array others, terus nambahin stok, sama ngurangin terjual
                            for(int i = 0;i<jumlahstatusbelanja;i++){
                                for(int j = 0;j<jumlahOthers;j++){
                                    
                                    if (strcmp(statusbelanja[i][0],others[j][0]) == 0 ){
                                        int Terjual = atoi(others[j][4]);
                                        Terjual -= 1;
                                        sprintf(others[j][4], "%d", Terjual);
